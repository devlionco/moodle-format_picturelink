...
/**
 * Strings for component 'format_picturelink', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['picturelinkbgcolor'] = 'צבע רקע';
$string['picturelinkbgcolor_help'] = 'בחר צבע רקע';
